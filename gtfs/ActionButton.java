...
/**
 * A button that you can define the onAction method on instantiation
 * @author keanej
 */
public class ActionButton extends Button {
    /**
     * Instantiates a button with its onAction method
     * @param text The title of the button
     * @param onAction The action to do on press
     */
    public ActionButton(String text, EventHandler<ActionEvent> onAction) {
        super(text);
